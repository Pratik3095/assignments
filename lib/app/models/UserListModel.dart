...
class UserListModel {
  ...
  num? _skip;
  num? _limit;
UserListModel copyWith({  List<Users>? users,
  num? total,
  num? skip,
  num? limit,
}) => UserListModel(  users: users ?? _users,
  total: total ?? _total,
  skip: skip ?? _skip,
  limit: limit ?? _limit,
);
...
/// title : "Sales Manager"
/// address : {"address":"263 Tenth Street","city":"San Francisco","state":"Wisconsin","stateCode":"WI","postalCode":"37657","coordinates":{"lat":71.814525,"lng":-161.150263},"country":"United States"}
